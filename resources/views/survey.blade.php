...
@section('survey')
        ...
        <div class="col-md-11 row">
            <div class="col-md-4 section-main-container">
                <div class="card shadow h-100 section-container">
                    <a href="javascript:void(0);" class="section_div" data-id="" data-name="" data-bs-toggle="modal"
            ...
            <div class="col-md-4 part-main-container">
                <div class="card shadow h-100 part-container">
                    <a href="javascript:void(0);" class="part_div" data-id="" data-name="" data-bs-toggle="modal"
    ...
    <div class="choices-container hide">
        ...
        <div class="col-md-12 row padding-0 margin-0 shadow">
            ...
            @foreach ($question_types as $key => $value)
                <div class="col-md-2">
                    <a href="javascript:void(0);" class="qtype_choice" data-id="{{ $value->id }}"
                        data-name="{{ $value->name }}" data-bs-toggle="modal" data-bs-target="#modal-add-question">
                        ...
                        @foreach ($value2['questions'] as $key => $value1)
                            <div class="col-md-12 survey-created-container" id="survey_id_{{ $value1['survey_id'] }}">
                                <div class="preview-title-container">
                                    ...
                                    <h4 class="h3 title-new-survey text-left text-capitalize">{{ $key + 1 }}.
                                ...
                                @else
                                    @foreach ($value1['sub_questions'] as $key4 => $sub_question)
                                        <h4 class="h3 title-new-survey title-sub-question text-left text-capitalize">
                                            {{ $key4 + 1 }}.
                                            {{ $sub_question }}</h4>
                                        @foreach ($value1['answers'] as $key => $ans)
                                            <div class="form-check col-md-12 row text-center align-middle"
                    ...
                    <div class="modal-footer text-left">
                        <div class="col-md-12 row">
                            ...
                            <div class="form-group col-md-6 text-right">
                                <button type="button"
                                    class="btn btn-modal-cancel btn-secondary bgWhite txt-black pull-right"
                                    data-bs-dismiss="modal">
                                    Cancel
                                </button>

                                <button type="button" id="question_create"
                                ...
                                <div class="form-group">
                                    <div class="col-md-12">
                                        <input type="text" name="survey"
                                            class="form-control form-control-user col-md-12" id="create_section_input"
                                            aria-describedby="emailHelp" placeholder="Add Section Name" />

                                        <button type="button" id="section_create"
                                            class="btn btn-primary btn-success float-right col-md-2"
    ...
    <form method="post" id="part_form" action="#">
        <div class="modal fade" id="modal-add-part" tabindex="-1" aria-labelledby="modal-add-part" aria-hidden="true">
            <div class="modal-dialog modal-dialog-centered modal-lg">
                <div class="modal-content">
                            ...
                            <div class="answer-container">
                                <div class="form-group">
                                    <div class="col-md-12">
                                        ...
                                        <input type="text" name="survey"
                                            class="form-control form-control-user col-md-12" id="create_part_input"
                                            aria-describedby="emailHelp" placeholder="Add Part Name" />

                                        <button type="button" id="part_create"
                                            class="btn btn-primary btn-success float-right col-md-2"
                                            style="margin-top: 10px;">
                                            Create
                                        </button>

...
<div class="row" style="padding-top: 40px;">
    ...
    <div class="choices-container hide">
        ...
        <div class="col-md-12 row padding-0 shadow">
            <div class="col-md-2" style="border-radius: 8px 0px 0px 0px;">
                    <a href="javascript:void(0);" data-bs-toggle="modal" data-bs-target="#modal-add-question">
                        ...
                        <p class="text-choice">Single choice</p> 
                    </a>
            </div>
            ...
            <div class="col-md-2">
                    <a href="javascript:void(0);">
                        <i class="fas fa-regular fa-check" aria-hidden="true"></i>  
                        <p class="text-choice">Multiple choice</p>     
                    </a>
            </div>
            <div class="col-md-2">
                    <a href="javascript:void(0);">
                        <i class="fas fa-regular fa-check" aria-hidden="true"></i>   
                        <p class="text-choice">Text answer</p>    
                    </a>
            </div>
            <div class="col-md-2">
                    <a href="javascript:void(0);">
                        <i class="fas fa-regular fa-check" aria-hidden="true"></i>  
                        <p class="text-choice">Image choice</p>     
                    </a>
            </div>
            <div class="col-md-2">
                    <a href="javascript:void(0);">
                        <i class="fas fa-regular fa-check" aria-hidden="true"></i>  
                        <p class="text-choice">Rating</p>     
                    </a>
            </div>
            <div class="col-md-2" style="border-radius: 0px 8px 0px 0px;">
                    <a href="javascript:void(0);">
                        <i class="fas fa-regular fa-check" aria-hidden="true"></i>  
                        <p class="text-choice">Semantic differential</p>     
                    </a>
            </div>
            <div class="col-md-2" style="border-radius: 0px 0px 0px 8px;">
                    <a href="javascript:void(0);">
                        <i class="fas fa-regular fa-check" aria-hidden="true"></i>     
                        <p class="text-choice">Net Promoter Score</p> 
                    </a>
            </div>
            <div class="col-md-2">
                    <a href="javascript:void(0);">
                        <i class="fas fa-regular fa-check" aria-hidden="true"></i>  
                        <p class="text-choice">Rating scale</p>     
                    </a>
            </div>
            <div class="col-md-2">
                    <a href="javascript:void(0);">
                        <i class="fas fa-regular fa-check" aria-hidden="true"></i>   
                        <p class="text-choice">Ordering</p>    
                    </a>
            </div>
            <div class="col-md-2">
                    <a href="javascript:void(0);">
                        <i class="fas fa-regular fa-check" aria-hidden="true"></i>  
                        <p class="text-choice">Matrix-single choices</p>     
                    </a>
            </div>
            <div class="col-md-2">
                    <a href="javascript:void(0);">
                        <i class="fas fa-regular fa-check" aria-hidden="true"></i>  
                        <p class="text-choice">MAtrix-multiple choices</p>     
                    </a>
            </div>
            <div class="col-md-2" style="border-radius: 0px 0px 8px 0px;">
                    <a href="javascript:void(0);">
                        <i class="fas fa-regular fa-check" aria-hidden="true"></i>  
                        <p class="text-choice">Custom text</p>     
                    </a>
            </div>
        </div>
    </div>
...
<form method="post" action="{{route('survey')}}">
    @csrf  {{ csrf_field() }} 
    <div class="modal fade" id="modal-add-question" tabindex="-1" aria-labelledby="modal-add-question" aria-hidden="true">
            ...
            <div class="modal-content">
                ...
                <div class="modal-body row">
                    <div class="form-group">
                        <textarea class="form-control" placeholder="Write your question here..." id="exampleFormControlTextarea1" rows="3"></textarea>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" name="survey" class="form-control form-control-user" id="exampleInputEmail"
                            aria-describedby="emailHelp" placeholder="Select one answer" />
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-12 row">
                            <input type="text" name="survey" class="form-control form-control-user col-md-11" id="exampleInputEmail"
                                aria-describedby="emailHelp" placeholder="Answer 1" />
                            <div class="col-md-1">
                    ...
                    <div class="form-group">
                        <div class="col-md-12 row">
                            <input type="text" name="survey" class="form-control form-control-user col-md-11" id="exampleInputEmail"
                                aria-describedby="emailHelp" placeholder="Answer 2" />
                            <div class="col-md-1">
                                <i class="fa fa-ellipsis-h" aria-hidden="true"></i>
                            </div>
                        </div>
                    ...
                    <div class="form-group">
                        <div class="col-md-12 row">
                            <input type="text" name="survey" class="form-control form-control-user col-md-11" id="exampleInputEmail"
                                aria-describedby="emailHelp" placeholder="Answer 3" />
                            <div class="col-md-1">
                                <i class="fa fa-ellipsis-h" aria-hidden="true"></i>
                            </div>
                        </div>
                    ...
                    <div class="form-group col-md-12 row">
                        ...
                        <div class="btn-group" style="background: #eee; padding: 15px 20px 15px 7px;">                           
                            <div class="dropdown col-md-8">
                                ...
                                <button class="btn dropdown-toggle add-question-dropdown" type="button" data-bs-toggle="dropdown" aria-expanded="false">
                    ...
                    <div class="col-md-12 row">
                        <div class="form-group col-md-6">
                            <div class="form-check">
                                <input class="form-check-input" type="checkbox" value="" id="add-question-req">
                        ...
                        <div class="form-group col-md-6 text-right">
                            <button type="button" class="btn btn-secondary bgWhite txt-black pull-right" data-bs-dismiss="modal">
                                Cancel
                            </button>

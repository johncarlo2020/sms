        ...
        <ul class="navbar-nav bg-side-menu sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <a class="sidebar-brand d-flex align-items-center justify-content-center" href="index.html">            
                <div class="sidebar-brand-text mx-3">
                    <div class="sidebar-brand-text" style="font-size: 13px;">Survey Management System</div>
                </div>
            </a>
            ...
            <li class="nav-item" style="padding: 17px;">
                ...
                <a class="nav-link padding-0" href="index.html">                    
                    <span>Myco</span>
                </a>
                <a class="nav-link padding-0" href="index.html">                    
        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                    ...
                    <ul class="navbar-nav ml-auto">
                        ...
                        <li class="nav-item dropdown no-arrow mx-1">
                            <a class="nav-link dropdown-toggle" href="#" id="messagesDropdown" role="button"
                                data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                                <i class="fas fa-solid fa-rotate fa-fw"></i>
                                <!-- Counter - Messages -->                                
                            </a>
                            <!-- Dropdown - Messages -->
                            <div class="dropdown-list dropdown-menu dropdown-menu-right shadow animated--grow-in"
                ...
                <div class="container-fluid row justify-content-md-center col-md-12">
                    ...
                    <h1 class="h3 mb-4 title-page-modal">Create your own survey or use a template</h1>
                        <div class="col-md-4">
                        ...
                        <div class="col-md-4">
                            ...
                            <img src="https://png.pngtree.com/thumb_back/fw800/back_our/20190625/ourmid/pngtree-office-desk-minimalist-background-picture-image_259887.jpg" alt="" style="width: 100%; height: 100%;">
                            </div>
                            <a href="#">
    ...
    <div class="modal-dialog modal-dialog-centered">
        ...
        <div class="modal-body">
            <div class="form-group">
                ...
                <input type="email" class="form-control form-control-user" id="exampleInputEmail" aria-describedby="emailHelp" placeholder="New survey">
            </div>
        </div>
        <div class="modal-footer text-left">
            <div class="col-md-12">
                <button type="button" class="btn btn-primary bgViolet">Continue</button>
                <button type="button" class="btn btn-secondary bgWhite txt-black" data-bs-dismiss="modal">Close</button>            
            </div>
        </div>
        </div>
    </div>
